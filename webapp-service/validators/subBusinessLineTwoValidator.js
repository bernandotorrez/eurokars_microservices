...
const createSchema = Joi.object({
  sub_business_line_2_name: Joi.string()
    .pattern(/^[a-zA-Z\s]+$/, 'Alphabet Only')
    .min(2)
    .max(50)
    .required()
    .messages({
      'string.min': charMinMaxLength('sub_business_line_2_name', '2', '50'),
      'string.max': charMinMaxLength('sub_business_line_2_name', '2', '50'),
      'string.pattern.name': alphabetOnly('sub_business_line_2_name')
    }),

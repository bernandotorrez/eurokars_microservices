    ...
    await queryInterface.sequelize.query(`
      CREATE TRIGGER ${triggerName}
        ...
        SET v_old_response = CONCAT(
          ...
          '  "tax_detail_description": "', IFNULL(OLD.tax_detail_description, ''), '",', CHAR(10),
          '  "percentage": "', IFNULL(OLD.percentage, ''), '",', CHAR(10),
        ...
        SET v_new_response = CONCAT(
          ...
          '  "tax_detail_description": "', IFNULL(NEW.tax_detail_description, ''), '",', CHAR(10),
          '  "percentage": "', IFNULL(NEW.percentage, ''), '",', CHAR(10),

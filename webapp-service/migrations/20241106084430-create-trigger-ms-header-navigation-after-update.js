    ...
    await queryInterface.sequelize.query(`
      CREATE TRIGGER ${triggerName}
        ...
        SET v_old_response = CONCAT(
          ...
          '  "header_navigation_name": "', IFNULL(OLD.header_navigation_name, ''), '",', CHAR(10),
          '  "sort_number": "', IFNULL(OLD.sort_number, ''), '",', CHAR(10),
          '  "url": "', IFNULL(OLD.url, ''), '",', CHAR(10),
          '  "remark": "', IFNULL(OLD.remark, ''), '",', CHAR(10),
          '  "level": "', IFNULL(OLD.level, ''), '",', CHAR(10),
          '  "is_other_sidebar": "', IFNULL(OLD.is_other_sidebar, ''), '",', CHAR(10),

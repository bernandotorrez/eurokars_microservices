    ...
    await queryInterface.sequelize.query(`
      CREATE TRIGGER ${triggerName}
        ...
        SET v_old_response = CONCAT(
          '{', CHAR(10),
          '  "tax_description": "', IFNULL(OLD.tax_description, ''), '",', CHAR(10),
          '  "tax_code": "', IFNULL(OLD.tax_code, ''), '",', CHAR(10),
          '  "tax_flag": "', IFNULL(OLD.tax_flag, ''), '",', CHAR(10),
        ...
        SET v_new_response = CONCAT(
          '{', CHAR(10),
          '  "tax_description": "', IFNULL(NEW.tax_description, ''), '",', CHAR(10),
          '  "tax_code": "', IFNULL(NEW.tax_code, ''), '",', CHAR(10),
          '  "tax_flag": "', IFNULL(NEW.tax_flag, ''), '",', CHAR(10),

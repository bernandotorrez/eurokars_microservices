  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            * 3. Check for duplicates data by checking tax_id AND percentage, if found then return 409
            ...
            */
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, tax_id, tax_detail_description, percentage, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_tax_id, p_tax_detail_description, p_percentage, p_user_id, NOW(), p_unique_id
            );

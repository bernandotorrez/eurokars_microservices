    ...
    await queryInterface.sequelize.query(`
      ...
      BEGIN
        ...
        SET v_old_response = CONCAT(
          '{', CHAR(10),
          '  "province_id": "', IFNULL(OLD.province_id, ''), '",', CHAR(10),
          '  "city_name": "', IFNULL(OLD.city_name, ''), '",', CHAR(10),
        ...
        SET v_new_response = CONCAT(
          '{', CHAR(10),
          '  "province_id": "', IFNULL(NEW.province_id, ''), '",', CHAR(10),
          '  "city_name": "', IFNULL(NEW.city_name, ''), '",', CHAR(10),

...
const prefix = 'sp';
const tableName = 'ms_sub_business_line_2';
const event = 'add'
const spName = `${prefix}_${event}_${tableName}`;
const primaryKey = 'sub_business_line_2_id';
const model = 'Sub Business Line 2';
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        CREATE PROCEDURE ${spName}(
            IN p_user_id VARCHAR(50),
            IN p_sub_business_line_2_name VARCHAR(50),
        ...
        proc_label: BEGIN
            ...
            * 2. Check for duplicates data by checking sub_business_line_2_name, if found then return 409
            ...
            */
            ...
            FROM ${tableName}
            WHERE sub_business_line_2_name = p_sub_business_line_2_name
            AND is_active = '1';

            IF v_duplicate_count >= 1 THEN
                SET v_return_code = 409;
                SET v_return_message = CONCAT(p_sub_business_line_2_name, ' already created');
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, sub_business_line_2_name, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_sub_business_line_2_name, p_user_id, NOW(), p_unique_id
            );

...
const primaryKey = 'category_rfa_id';
const model = 'Category RFA';
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        CREATE PROCEDURE ${spName}(
            IN p_user_id VARCHAR(50),
            IN p_category_rfa_code VARCHAR(10),
            IN p_category_rfa_name VARCHAR(50),
            IN p_category_rfa_description TEXT,
        ...
        proc_label: BEGIN
            ...
            * 2. Check for duplicates data by checking (category_rfa_name OR category_rfa_code), if found then return 409
            ...
            */
            ...
            FROM ${tableName}
            WHERE (category_rfa_code = UPPER(p_category_rfa_code)
            OR category_rfa_name = p_category_rfa_name)
            AND is_active = '1';

            IF v_duplicate_count >= 1 THEN
                SET v_return_code = 409;
                SET v_return_message = CONCAT(UPPER(p_category_rfa_code), ' or ', p_category_rfa_name, ' already created');
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, category_rfa_name, category_rfa_code, category_rfa_description, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_category_rfa_name, p_category_rfa_code, p_category_rfa_description, p_user_id, NOW(), p_unique_id
            );

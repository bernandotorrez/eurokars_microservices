  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            * 4. Check for duplicates data by checking (user_id AND division_id), if found then return 409
            ...
            */
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, user_id, division_id, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_user_id, p_division_id, p_user_id, NOW(), p_unique_id
            );

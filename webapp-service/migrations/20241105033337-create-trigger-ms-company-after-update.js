    ...
    await queryInterface.sequelize.query(`
      CREATE TRIGGER ${triggerName}
        ...
        BEGIN
          ...
          DECLARE v_new_response LONGTEXT; -- Change JSON to LONGTEXT
          DECLARE v_old_response LONGTEXT; -- Change JSON to LONGTEXT
          ...
          SET v_old_response = CONCAT(
              '{', CHAR(10),
              '"company_name": "', IFNULL(OLD.company_name, ''), '",', CHAR(10),
              '"company_code": "', IFNULL(OLD.company_code, ''), '",', CHAR(10),
          ...
          SET v_new_response = CONCAT(
              '{', CHAR(10),
              '"company_name": "', IFNULL(NEW.company_name, ''), '",', CHAR(10),
              '"company_code": "', IFNULL(NEW.company_code, ''), '",', CHAR(10),

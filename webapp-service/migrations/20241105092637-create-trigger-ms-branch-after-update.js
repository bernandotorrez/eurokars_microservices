    ...
    await queryInterface.sequelize.query(`
      CREATE TRIGGER ${triggerName}
        ...
        SET v_old_response = CONCAT(
          '{', CHAR(10),
          '  "city_id": "', IFNULL(OLD.city_id, ''), '",', CHAR(10),
          '  "branch_name": "', IFNULL(OLD.branch_name, ''), '",', CHAR(10),
          '  "branch_code": "', IFNULL(OLD.branch_code, ''), '",', CHAR(10),
        ...
        SET v_new_response = CONCAT(
          '{', CHAR(10),
          '  "city_id": "', IFNULL(NEW.city_id, ''), '",', CHAR(10),
          '  "branch_name": "', IFNULL(NEW.branch_name, ''), '",', CHAR(10),
          '  "branch_code": "', IFNULL(NEW.branch_code, ''), '",', CHAR(10),

    ...
    await queryInterface.sequelize.query(`
      CREATE TRIGGER ${triggerName}
        ...
        SET v_old_response = CONCAT(
          '{', CHAR(10),
          '  "category_rfa_code": "', IFNULL(OLD.category_rfa_code, ''), '",', CHAR(10),
          '  "category_rfa_name": "', IFNULL(OLD.category_rfa_name, ''), '",', CHAR(10),
          '  "category_rfa_description": "', IFNULL(OLD.category_rfa_description, ''), '",', CHAR(10),
        ...
        SET v_new_response = CONCAT(
          '{', CHAR(10),
          '  "category_rfa_code": "', IFNULL(NEW.category_rfa_code, ''), '",', CHAR(10),
          '  "category_rfa_name": "', IFNULL(NEW.category_rfa_name, ''), '",', CHAR(10),
          '  "category_rfa_description": "', IFNULL(NEW.category_rfa_description, ''), '",', CHAR(10),

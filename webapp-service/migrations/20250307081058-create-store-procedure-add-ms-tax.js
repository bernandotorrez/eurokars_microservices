  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        CREATE PROCEDURE ${spName}(
            ...
            IN p_tax_description VARCHAR(200),
            IN p_tax_code VARCHAR(10),
        ...
        proc_label: BEGIN
            ...
            * 2. Check for duplicates data by checking (tax_description OR tax_code), if found then return 409
            ...
            */
            ...
            FROM ${tableName}
            WHERE (tax_code = UPPER(p_tax_code)
            OR tax_description = p_tax_description)
            AND is_active = '1';

            IF v_duplicate_count >= 1 THEN
                SET v_return_code = 409;
                SET v_return_message = CONCAT(p_tax_description, ' or ', p_tax_code, ' already created');
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, tax_description, tax_code, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_tax_description, p_tax_code, p_user_id, NOW(), p_unique_id
            );

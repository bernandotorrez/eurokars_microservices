    ...
    await queryInterface.sequelize.query(`
      CREATE TRIGGER ${triggerName}
        ...
        SET v_old_response = CONCAT(
          '{', CHAR(10),
          '  "coa_code": "', IFNULL(OLD.coa_code, ''), '",', CHAR(10),
          '  "coa_name": "', IFNULL(OLD.coa_name, ''), '",', CHAR(10),
          '  "coa_description": "', IFNULL(OLD.coa_description, ''), '",', CHAR(10),
        ...
        SET v_new_response = CONCAT(
          '{', CHAR(10),
          '  "coa_code": "', IFNULL(NEW.coa_code, ''), '",', CHAR(10),
          '  "coa_name": "', IFNULL(NEW.coa_name, ''), '",', CHAR(10),
          '  "coa_description": "', IFNULL(NEW.coa_description, ''), '",', CHAR(10),

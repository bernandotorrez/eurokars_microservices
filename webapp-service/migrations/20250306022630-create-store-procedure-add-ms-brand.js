...
const prefix = 'sp';
const tableName = 'ms_brand';
const event = 'add'
const spName = `${prefix}_${event}_${tableName}`;
const primaryKey = 'brand_id';
const model = 'Brand';
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            * 2. Check for duplicates data by checking brand_name, if found then return 409
            ...
            */
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, brand_name, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_brand_name, p_user_id, NOW(), p_unique_id
            );

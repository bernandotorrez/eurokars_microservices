  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            * 2. Check for duplicates data by checking (currency_name OR currency_code), if found then return 409
            ...
            */
            ...
            FROM ${tableName}
            WHERE (currency_name = p_currency_name OR currency_code = p_currency_code)
            AND is_active = '1';

            IF v_duplicate_count >= 1 THEN
                SET v_return_code = 409;
                SET v_return_message = CONCAT(p_currency_name, ' OR ', p_currency_code, ' already created');
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, currency_name, currency_code, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_currency_name, p_currency_code, p_user_id, NOW(), p_unique_id
            );

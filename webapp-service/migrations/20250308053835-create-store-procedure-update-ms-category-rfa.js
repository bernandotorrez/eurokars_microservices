  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            * 3. Check for duplicates data by checking (category_rfa_name OR category_rfa_code), if found then return 409
            * 4. Insert data
            */
            ...
            -- Update data
            UPDATE ${tableName}
            SET category_rfa_name = p_category_rfa_name,
            category_rfa_code = p_category_rfa_code,
            category_rfa_description = p_category_rfa_description,

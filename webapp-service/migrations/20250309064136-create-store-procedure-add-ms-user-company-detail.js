  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            * 4. Check for duplicates data by checking (user_id AND company_detail_id), if found then return 409
            ...
            */
            ...
            -- if user company detail not found then return 404
            ...
            -- Check if company_detail exists
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, user_id, company_detail_id, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_user_id, p_company_detail_id, p_user_id, NOW(), p_unique_id
            );

    ...
    await queryInterface.sequelize.query(`
      CREATE TRIGGER ${triggerName}
        ...
        SET v_old_response = CONCAT(
          '{', CHAR(10),
          '  "coa_id": "', IFNULL(OLD.coa_id, ''), '",', CHAR(10),
          '  "sub_coa_code": "', IFNULL(OLD.sub_coa_code, ''), '",', CHAR(10),
          '  "sub_coa_name": "', IFNULL(OLD.sub_coa_name, ''), '",', CHAR(10),
          '  "sub_coa_description": "', IFNULL(OLD.sub_coa_description, ''), '",', CHAR(10),
        ...
        SET v_new_response = CONCAT(
          '{', CHAR(10),
          '  "coa_id": "', IFNULL(NEW.coa_id, ''), '",', CHAR(10),
          '  "sub_coa_code": "', IFNULL(NEW.sub_coa_code, ''), '",', CHAR(10),
          '  "sub_coa_name": "', IFNULL(NEW.sub_coa_name, ''), '",', CHAR(10),
          '  "sub_coa_description": "', IFNULL(NEW.sub_coa_description, ''), '",', CHAR(10),

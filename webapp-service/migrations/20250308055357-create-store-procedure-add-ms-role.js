  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            * 2. Check for duplicates data by checking (role_name OR role_code), if found then return 409
            ...
            */
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, role_name, role_code, role_description, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_role_name, p_role_code, p_role_description, p_user_id, NOW(), p_unique_id
            );

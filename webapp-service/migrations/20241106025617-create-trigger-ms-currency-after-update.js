    ...
    await queryInterface.sequelize.query(`
      CREATE TRIGGER ${triggerName}
        ...
        SET v_old_response = CONCAT(
          '{', CHAR(10),
          '  "currency_name": "', IFNULL(OLD.currency_name, ''), '",', CHAR(10),
          '  "currency_code": "', IFNULL(OLD.currency_code, ''), '",', CHAR(10),
        ...
        SET v_new_response = CONCAT(
          '{', CHAR(10),
          '  "currency_name": "', IFNULL(NEW.currency_name, ''), '",', CHAR(10),
          '  "currency_code": "', IFNULL(NEW.currency_code, ''), '",', CHAR(10),

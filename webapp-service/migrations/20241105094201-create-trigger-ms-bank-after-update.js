    ...
    await queryInterface.sequelize.query(`
      CREATE TRIGGER ${triggerName}
        ...
        SET v_old_response = CONCAT(
          '{', CHAR(10),
          '  "bank_name": "', IFNULL(OLD.bank_name, ''), '",', CHAR(10),
          '  "local_code": "', IFNULL(OLD.local_code, ''), '",', CHAR(10),
          '  "swift_code": "', IFNULL(OLD.swift_code, ''), '",', CHAR(10),
        ...
        SET v_new_response = CONCAT(
          '{', CHAR(10),
          '  "bank_name": "', IFNULL(NEW.bank_name, ''), '",', CHAR(10),
          '  "local_code": "', IFNULL(NEW.local_code, ''), '",', CHAR(10),
          '  "swift_code": "', IFNULL(NEW.swift_code, ''), '",', CHAR(10),

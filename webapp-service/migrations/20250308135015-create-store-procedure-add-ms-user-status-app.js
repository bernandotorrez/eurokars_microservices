  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            * 2. Check if user param (user for status app) exists, if not found then return 404
            * 3. Check if status app exists, if not found then return 404
            * 4. Check for duplicates data by checking (user_id AND status_app_id), if found then return 409
            ...
            */
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, user_id, status_app_id, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_user_id, p_status_app_id, p_user_id, NOW(), p_unique_id
            );

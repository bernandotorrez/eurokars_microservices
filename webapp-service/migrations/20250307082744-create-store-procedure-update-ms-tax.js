  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            * 2. Check if ${model} is exists
            * 3. Check for duplicates data by checking (tax_description OR tax_code), if found then return 409
            * 4. Insert data
            */
            ...
            -- Update data
            UPDATE ${tableName}
            SET tax_description = p_tax_description,
            tax_code = p_tax_code,

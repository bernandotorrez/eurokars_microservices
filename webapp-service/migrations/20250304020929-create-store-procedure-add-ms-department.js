    ...
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, department_name, department_code, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_department_name, p_department_code, p_user_id, NOW(), p_unique_id
            );

  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
        ...
        proc_label: BEGIN
            ...
            * 2. Check for duplicates data by checking business_line_name, if found then return 409
            ...
            */
            ...
            INSERT INTO ${tableName} (
                ${primaryKey}, business_line_name, created_by, created_date, unique_id
            ) VALUES (
                v_generated_id, p_business_line_name, p_user_id, NOW(), p_unique_id
            );

...
class ProvinceRepository {
  ...
  async add (userId, params) {
    ...
    try {
      ...
      const [results] = await sequelize.query(
        'CALL sp_add_ms_province(:userId, :provinceName, :screenId, :uniqueId);',
        {
          replacements: { userId, provinceName, screenId, uniqueId },
  ...
  async update (id, userId, params) {
    ...
    try {
      // Call the stored procedure
      const [results] = await sequelize.query(
        'CALL sp_update_ms_province(:userId, :provinceName, :uniqueId);',
        {
          replacements: { userId, provinceName, uniqueId: id },
          type: sequelize.QueryTypes.RAW
        }
      );
